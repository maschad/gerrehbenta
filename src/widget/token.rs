...
impl TokenState {
    pub fn new(symbol: String, chart_type: ChartType) -> TokenState {
...
impl CachableWidget<TokenState> for StockWidget {
    fn cache_state_mut(state: &mut TokenState) -> &mut CacheState {
